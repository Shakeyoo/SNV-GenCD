...
def main():
    ...
    #parser.add_argument('--cfg', type=str, default='/media/mcislab/WYY/project/MambaCD/classification/configs/vssm1/vssm_small_224.yaml')
    ...
    #parser.add_argument('--pretrained_weight_path', type=str,default="/media/mcislab/WYY/project/MambaCD/vssm_small_0229_ckpt_epoch_222.pth")
    ...
    parser.add_argument('--test_dataset_path', type=str, default='/media/mcislab/WYY/datasets/LEVIR-CD/test')
    parser.add_argument('--test_data_list_path', type=str, default='/media/mcislab/WYY/datasets/LEVIR-CD/test/test_list.txt')
    #parser.add_argument('--test_dataset_path', type=str, default='/media/mcislab/WYY/datasets/WHU-CD/test/')
    #parser.add_argument('--test_data_list_path', type=str, default='/media/mcislab/WYY/datasets/WHU-CD/test/test_list.txt')
    #parser.add_argument('--test_dataset_path', type=str, default='/media/mcislab/WYY/test/self/')
    #parser.add_argument('--test_data_list_path', type=str, default='/media/mcislab/WYY/test/self/train_list.txt')
    ...
    parser.add_argument('--max_iters', type=int, default=17000)
    parser.add_argument('--model_type', type=str, default='MambaBCD_samll')
    parser.add_argument('--result_saved_path', type=str, default="/media/mcislab/WYY/project/MambaCD/resultsmap/levircd/my/")
    #parser.add_argument('--result_saved_path', type=str, default="/media/mcislab/WYY/test/self/resultsmapWHU2/")


    parser.add_argument('--resume', type=str,default="/media/mcislab/WYY/project/MambaCD/results/LEVIR-CD+/实验/mylevircd/6000_model.pth")
